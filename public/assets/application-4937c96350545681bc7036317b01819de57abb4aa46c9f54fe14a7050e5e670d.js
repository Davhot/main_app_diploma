...
(function() {
  var apps_functions, link_app, toggle_errors;
  ...
  toggle_errors = function() {
    return $("table[data-toggle-error]").click(function() {
      var id;
      id = $(this).data("toggle-error");
      return $(id).toggle(300);
    });
  };

  apps_functions = function() {
    link_app();
    return toggle_errors();
  };
